window.onload = function () {
    var data = {     //模拟后台数据 的一个JSON格式的文件
        "data": [
            { "src": "https://pic3.zhimg.com/v2-013cc2eb1c4f24f4279c83354028dc56_r.jpg" },
            { "src": "https://img.zcool.cn/community/0130215bf57cb3a80121ab5db623c5.jpg@1280w_1l_2o_100sh.jpg" },
            { "src": "https://img.sj33.cn/uploads/allimg/201711/7-1G113092320.jpg" },
            { "src": "https://www.php3.cn/upload/ckfinder/images/p20279577.jpg" },
            { "src": "https://p1.ssl.qhimg.com/t01004785dc74b5ac86.jpg" }
        ]
    };
    window.onscroll = function () {
        ...
        if (checkScroll()) {   //判断是否具备滚动加载得条件
            ...
            for (var i = 0; i < data.data.length; i++) {
                ...
                imgs.src = data.data[i].src; //设置读取路径
